...
const Home = (props) => {
  ...
  return(
    <ImageBackground source={Fundo} resizeMode="cover" style={styles.container}>
          ...
          <Text style={{color:"#fff", fontSize: 16, marginBottom: 30, textShadowColor: "#000",textShadowOffset: {width: 1, height: 1},textShadowRadius: 3, textShadowColor: "rgba(0, 0, 0, 0.75)",textShadowOffset: {width: 1, height: 1}, textShadowRadius: 1,}}>ou acesse com:</Text>
